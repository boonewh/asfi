export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.asficonstruction.com/images/bridge1.jpg',
        width: 1200,
        height: 630,
        alt: 'ASFI Construction bridge deck waterproofing application',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.asficonstruction.com/bridge-waterproofing',
  },
  robots: {
    index: true,
    follow: true,
...
export default function BridgeWaterproofingLayout({ children }) {
  return children;
}
