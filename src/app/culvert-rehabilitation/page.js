    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50 border-t-4 border-orange-500">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-800 mb-6">
              Professional Lining and Coating Services
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              As a Nationwide service provider, ASFI Construction offers Professional Lining and Coating Services.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {applications.map((app, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all p-6 text-center group">
                <div className="bg-orange-100 rounded-full p-4 inline-block mb-4 group-hover:bg-orange-200 transition-colors">
                  <app.icon className="h-8 w-8 text-orange-600" />
                </div>
